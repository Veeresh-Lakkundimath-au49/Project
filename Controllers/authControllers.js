...
let signup = async (req, res) => {
    ...
    try {
        ...
        res.sendFile('C:/Users/dhruv/OneDrive/Desktop/book library website/public/login.html')
    } catch (err) {
...
let login = async (req, res) => {
    ...
    try {
        ...
        if (!user) {
            ...
            res.sendFile('C:/Users/dhruv/OneDrive/Desktop/book library website/public/profile.html')
        }
    } catch (err) {
        console.log(err);
